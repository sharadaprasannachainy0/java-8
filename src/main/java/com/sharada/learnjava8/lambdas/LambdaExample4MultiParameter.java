...
// Java code to illustrate lambda expression with multi parameters
...
class LambdaExample4MultiParameter {
    ...
    {
        // lambda expression is passed with two parameters
        // lambda expression is mapped to the double argument abstract function in the functional interface Test3
        fun((p1, p2)
